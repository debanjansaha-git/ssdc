function jso(Runs,fhd,problem_size,funcs,max_nfes,pop_size,optimum)
...
%             end
            ...
            %% jSO Changes - how to incorporate F_i,g > 0. check?
            if (g_iter < 0.6 * GMax)
                sf = min(sf,0.7);
            end
            ...
            vi = pop + sfw(:, ones(1, problem_size)) .* (pbest - pop) + ...
                sf(:, ones(1, problem_size)).*(pop(r1, :) - popAll(r2, :));
